This folder contains code to simulate evolution under directional selection in non-Wright-Fisher populations.

Structure of data files (files whose names start with "sim_out_") is explained below.

Column 2: Population size at the end of the simulation.
Column 3: Mean of a trait.
Column 4: Mean within-population variance of a trait.
